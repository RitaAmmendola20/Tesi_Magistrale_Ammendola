...
if __name__ == "__main__":
    ...
    for subject in tqdm(range(1, 110), desc="Evaluating subjects", unit="subject"):
        for run in range(1, 14):
            ...
            test_dataset = util_pixel.EEGDataset(subject_ids=[subject], runs=[run], project_path=project_path, add_noise=False)
    ...
    # --- Salva in CSV ---
    csv_path = os.path.join(project_path, "pixel_evaluation_results_all_subjects_runs.csv")
